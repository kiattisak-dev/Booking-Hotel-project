...
export default function RoomDetail() {
  ...
  const safe = useMemo<SafeRoom>(() => {
    ...
    return {
      ...
      unavailableDates: Array.isArray(r.unavailableDates)
        ? (r.unavailableDates as string[])
        : [],
    };
  }, [room]);
        ...
        >
          ...
          <div className="lg:grid lg:grid-cols-3 lg:gap-8">
            <div className="lg:col-span-2">
              ...
              {safe.description ? (
                <p className="text-gray-600 text-lg mb-6">{safe.description}</p>
              ) : null}
